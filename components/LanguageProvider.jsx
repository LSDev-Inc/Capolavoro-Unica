...
const translations = {
  it: {
    ...
    "login.emailCode": "Accedi con codice email",
    ...
    "forgot.subtitle": "Ricevi un link per impostare una nuova password.",
    "forgot.button": "Invia link di reset",
    "forgot.buttonLoading": "Invio...",
    "forgot.sent": "Se l'email esiste, abbiamo inviato il link.",
    "reset.title": "Nuova password",
    "reset.subtitle": "Imposta una nuova password per rientrare.",
    "reset.passwordLabel": "Nuova password",
    "reset.button": "Salva password",
    "reset.buttonLoading": "Salvataggio...",
    "reset.success": "Password aggiornata. Ora puoi accedere.",
    "reset.missing": "Link non valido o incompleto.",
    "loginEmail.title": "Accesso con codice email",
    "loginEmail.subtitle": "Ricevi un codice temporaneo se non hai la 2FA.",
    "loginEmail.button": "Invia codice",
    "loginEmail.buttonLoading": "Invio...",
    "loginEmail.sent": "Se l'email esiste, il codice e' stato inviato.",
    "loginEmail.codeLabel": "Codice di accesso",
    "loginEmail.verify": "Verifica codice",
    "loginEmail.verifyLoading": "Verifica...",
    "loginEmail.resend": "Invia di nuovo il codice",
    "loginEmail.success": "Accesso confermato.",
  ...
  en: {
    ...
    "login.emailCode": "Sign in with email code",
    ...
    "forgot.subtitle": "Get a link to set a new password.",
    "forgot.button": "Send reset link",
    "forgot.buttonLoading": "Sending...",
    "forgot.sent": "If the email exists, we sent the link.",
    "reset.title": "New password",
    "reset.subtitle": "Set a new password to continue.",
    "reset.passwordLabel": "New password",
    "reset.button": "Save password",
    "reset.buttonLoading": "Saving...",
    "reset.success": "Password updated. You can sign in now.",
    "reset.missing": "Invalid or incomplete link.",
    "loginEmail.title": "Email code sign-in",
    "loginEmail.subtitle": "Get a temporary code if you do not use 2FA.",
    "loginEmail.button": "Send code",
    "loginEmail.buttonLoading": "Sending...",
    "loginEmail.sent": "If the email exists, the code has been sent.",
    "loginEmail.codeLabel": "Login code",
    "loginEmail.verify": "Verify code",
    "loginEmail.verifyLoading": "Verifying...",
    "loginEmail.resend": "Resend code",
    "loginEmail.success": "Signed in successfully.",
...
const errorTranslations = {
  ...
  "Password reset token invalid.": {
    it: "Token di reset password non valido.",
    en: "Password reset token invalid."
  },
  "Password reset token expired.": {
    it: "Token di reset password scaduto.",
  ...
  "2FA enabled. Use standard login.": {
    it: "2FA attiva. Usa l'accesso standard.",
    en: "2FA enabled. Use standard login."
  },
  "Login code locked. Try again later.": {
    it: "Codice accesso bloccato. Riprova piu' tardi.",
    en: "Login code locked. Try again later."
  },
  "Login code expired.": {
    it: "Codice accesso scaduto.",
    en: "Login code expired."
  },
